...
Config.DisableSprintJump = true -- Enable to disable sprint / jump while carrying brick
Config.Key = "G"

-- PAYMENTS / DROP COUNTER --
Config.Moneytype = 'cash' -- Set to cash or bank
Config.PayPerDrop = 0.15 -- Pay is 0.50 cents per drop
...
Config.DoMiniGame = false -- Disable minigame for brick placement
